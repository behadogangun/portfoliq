...
def get_economic_calendar():
    ...
    static_events = [
        {'date': f'{year}-{month:02d}-05', 'event': 'US Non-Farm Payrolls', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'high', 'impact_color': '#c4162a'},
        {'date': f'{year}-{month:02d}-10', 'event': 'US CPI (Inflation)', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'high', 'impact_color': '#c4162a'},
        {'date': f'{year}-{month:02d}-15', 'event': 'US Retail Sales', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'medium', 'impact_color': '#ff9500'},
        {'date': f'{year}-{month:02d}-20', 'event': 'Fed Interest Rate Decision', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'high', 'impact_color': '#c4162a'},
        {'date': f'{year}-{month:02d}-22', 'event': 'US GDP Growth Rate', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'high', 'impact_color': '#c4162a'},
        {'date': f'{year}-{month:02d}-25', 'event': 'US PCE Price Index', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'medium', 'impact_color': '#ff9500'},
        {'date': f'{year}-{month:02d}-28', 'event': 'US Consumer Confidence', 'country': 'US', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'medium', 'impact_color': '#ff9500'},
        {'date': f'{year}-{month:02d}-12', 'event': 'EU ECB Rate Decision', 'country': 'EU', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'high', 'impact_color': '#c4162a'},
        {'date': f'{year}-{month:02d}-18', 'event': 'UK CPI Inflation', 'country': 'UK', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'medium', 'impact_color': '#ff9500'},
        {'date': f'{year}-{month:02d}-08', 'event': 'CN Trade Balance', 'country': 'CN', 'actual': '', 'estimate': '', 'prev': '', 'impact': 'medium', 'impact_color': '#ff9500'},
    ]
